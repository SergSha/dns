...
<ol>
<li>1. взять стенд https://github.com/erlong15/vagrant-bind<br />
...
<li>2. настроить split-dns<br />
клиент1 - видит обе зоны, но в зоне dns.lab только web1<br />
клиент2 видит только dns.lab<br /><br />
Дополнительное задание<br />
* настроить все без выключения selinux</li>
</ol>
...
<pre>dig @192.168.50.10 web1.dns.lab</pre>
